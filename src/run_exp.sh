...
python run_cora_multi.py kipf mean_pool h h 1 1 0 & #
sleep 2s
...
python run_movielens.py kipf mean_pool h h 1 1 0 & #
sleep 2s
python run_movielens.py kipf max_pool h h 1 1 3 #
sleep 2s
python run_movielens.py kipf attention h h 1 1 0 &
sleep 2s
python run_movielens.py kipf lstm_attention h h 1 1 3 #
sleep 2s
...
sleep 2s
#python run_reddit_trans.py chebyshev mean_pool h h 1 1 2 &
#sleep 2s
...
#python run_reddit_trans.py kipf mean_pool h h 1 1 0 &
#sleep 2s
...
#python run_ppigs.py kipf mean_pool h h 1 1 4 & #
#sleep 2s
