...
class Parser(object):  #
    def __init__(self):
        ...
        parser.add_argument("--fusion", default='bin_attention2', choices=['mean_pool', 'max_pool', 'attention', 'lstm_attention',
                                                                           'mean_pool2', 'max_pool2', 'attention2',
                                                                           'lstm_attention2', 'bin_attention', 'bin_attention2'])
        ...
        # Dataset Details
        parser.add_argument("--dataset", default='mlgene', help="Dataset to evluate | Check Datasets folder",
