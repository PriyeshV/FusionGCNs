...
class Parser(object):  #
    def __init__(self):
        ...
        parser.add_argument("--dims", default='16,16,128,8,8', help="Dimensions of hidden layers: comma separated")
        ...
        parser.add_argument("--folds", default='4', help="Training folds comma separated")
