...
class Parser(object):  #
    def __init__(self):
        ...
        parser.add_argument("--fusion", default='bin_attention', choices=['mean_pool', 'max_pool', 'attention', 'lstm_attention',
                                                                           'mean_pool2', 'max_pool2', 'attention2',
                                                                           'lstm_attention2', 'bin_attention'])
        ...
        parser.add_argument("--l2", default=0., help="L2 loss", type=float)
